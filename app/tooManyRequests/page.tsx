      ...
      <Card className="flex flex-col gap-2 justify-center max-w-[500px] mx-auto border-destructive bg-background w-[90%]">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            <h2 className="text-[2rem] font-[500]">Zwolnij!</h2>
          </CardTitle>
          <CardDescription>
            Spróbuj ponownie za 30 sekund. Liczba zapytań do serwera jest
            limitowana. Jeśli uważasz, że limit jest zbyt niski - skontaktuj się
            z administratorem.
          </CardDescription>
        </CardHeader>
