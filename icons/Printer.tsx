export default function Printer({ className }: { className?: string }) {
  return (
    <svg
      width="800px"
      height="800px"
      ...
      className={className}
    >
      <path d="M16 15V19C16 20.66 14.66 22 13 22H11C9.34 22 8 20.66 8 19V15H16Z" />
      <path d="M7 7V5C7 3.34 8.34 2 10 2H14C15.66 2 17 3.34 17 5V7H7Z" />
      <path
        opacity="0.4"
      ...
      />
      <path d="M10.75 11C10.75 11.41 10.41 11.75 10 11.75H7C6.59 11.75 6.25 11.41 6.25 11C6.25 10.59 6.59 10.25 7 10.25H10C10.41 10.25 10.75 10.59 10.75 11Z" />
